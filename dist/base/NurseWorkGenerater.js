...
const CalendarDate_1 = require("../utill/CalendarDate");
const NurseWork_1 = require("./NurseWork");
class NurseWorkGenerater {
    constructor() {
        this.bInit = false;
    }
    initailize(param) {
        this.param = param;
        this.lastDay = CalendarDate_1.CalendarDate.getLastDay(this.param.toYear, this.param.toMonth);
        this.daysOfWeek = CalendarDate_1.CalendarDate.getDaysOfWeek(this.param.toYear, this.param.toMonth);
    ...
    create() {
        ...
        for (let i = 0; i < cntNurse; ++i) {
            if (undefined === tNurseWorks[i]) {
                tNurseWorks[i] = new NurseWork_1.NurseWork(i);
...
exports.NurseWorkGenerater = NurseWorkGenerater;
//# sourceMappingURL=NurseWorkGenerater.js.map